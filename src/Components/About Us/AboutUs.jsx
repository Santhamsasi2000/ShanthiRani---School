const AboutUs = () => {
  return (
    <section className="p-3 p-sm-5 common-bg">
        <p className='title mb-4'>ABOUT OUR SCHOOL</p>
       ...
       <>
        ...
        <p className="lh-lg text-justify">Shanthi Rani Matric. Hr. Sec. School is a Catholic Co-education Institution established and managed by the Sisters of Daughters of Charity of St. Vincent De Paul. Shanthi Rani Matric. Hr. Sec. School is primarily meant for catering the educational needs of the local students. It is open to students of all communities irrespective of religion, caste, colour or creed. It maintains its Christian identity and Character.</p>
        <p className='fw-bold'>HISTORY OF OUR SCHOOL</p> 
        <p className="lh-lg text-justify">The name "Shanthi Rani" stands for "The Queen of Peace". Shanthi Rani Matric Higher Secondary School has been running successfully by the Daughters of Charity of St.Vincent de Paul for the past 26 years. </p> 
        <p className='fw-bold'>MIRROR OF OUR SCHOOL</p> 
        <p className="lh-lg text-justify">Shanthi Rani Matric Higher Secondary School sprouted in the year 1997, with mere 35 students.  Even after the pandemic, we are thankful to the Almighty and proud to inform you that our perseverance and persistence has increased the strength of the students up to 1705.  At present our school excels with 77 teaching faculties and 30 non-teaching staff who are striving for the betterment of our Institution. </p>
        <p className='fw-bold'>MOTTO OF OUR SCHOOL</p> 
        <p className='fw-semibold'>"Knowledge is to serve"</p>
        <p className="lh-lg text-justify">Knowledge demonstrates a greater life and strengthens all of the highest 
